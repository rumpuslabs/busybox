...
output single/double edge mode control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmsel2(&mut self) -> PWMSEL2_W<CR_SPEC, 2> {
        PWMSEL2_W::new(self)
    }
    #[doc = "Bit 3 - PWM\\[3\\]
output edge control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmsel3(&mut self) -> PWMSEL3_W<CR_SPEC, 3> {
        PWMSEL3_W::new(self)
    }
    #[doc = "Bit 4 - PWM\\[4\\]
output edge control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmsel4(&mut self) -> PWMSEL4_W<CR_SPEC, 4> {
        PWMSEL4_W::new(self)
    }
    #[doc = "Bit 5 - PWM\\[5\\]
output edge control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmsel5(&mut self) -> PWMSEL5_W<CR_SPEC, 5> {
        PWMSEL5_W::new(self)
    }
    #[doc = "Bit 6 - PWM\\[6\\]
output edge control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmsel6(&mut self) -> PWMSEL6_W<CR_SPEC, 6> {
        PWMSEL6_W::new(self)
    }
    #[doc = "Bit 9 - PWM\\[1\\]
output enable control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmena1(&mut self) -> PWMENA1_W<CR_SPEC, 9> {
        PWMENA1_W::new(self)
    }
    #[doc = "Bit 10 - PWM\\[2\\]
output enable control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmena2(&mut self) -> PWMENA2_W<CR_SPEC, 10> {
        PWMENA2_W::new(self)
    }
    #[doc = "Bit 11 - PWM\\[3\\]
output enable control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmena3(&mut self) -> PWMENA3_W<CR_SPEC, 11> {
        PWMENA3_W::new(self)
    }
    #[doc = "Bit 12 - PWM\\[4\\]
output enable control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmena4(&mut self) -> PWMENA4_W<CR_SPEC, 12> {
        PWMENA4_W::new(self)
    }
    #[doc = "Bit 13 - PWM\\[5\\]
output enable control."]
    #[inline(always)]
    #[must_use]
    pub fn pwmena5(&mut self) -> PWMENA5_W<CR_SPEC, 13> {
        PWMENA5_W::new(self)
    }
    #[doc = "Bit 14 - PWM\\[6\\]
output enable control. See PWMENA1 for details."]
    #[inline(always)]
    #[must_use]
    pub fn pwmena6(&mut self) -> PWMENA6_W<CR_SPEC, 14> {
        PWMENA6_W::new(self)
    }
