...
pub type TC_R = crate::FieldReader<u32>;
#[doc = "Field `TC` writer - Timer counter value."]
pub type TC_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TC")
            .field("tc", &format_args!("{}", self.tc().bits()))
            .finish()
    }
}
#[cfg(feature = "debug")]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tc(&mut self) -> TC_W<TC_SPEC, 0> {
        TC_W::new(self)
    }
