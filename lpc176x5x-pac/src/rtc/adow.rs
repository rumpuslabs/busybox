...
pub type R = crate::R<ADOW_SPEC>;
#[doc = "Register `ADOW` writer"]
pub type W = crate::W<ADOW_SPEC>;
...
#[cfg(feature = "debug")]
impl core::fmt::Debug for crate::generic::Reg<ADOW_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dow(&mut self) -> DOW_W<ADOW_SPEC, 0> {
        DOW_W::new(self)
    }
...
#[doc = "Alarm value for Day of Week\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`adow::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`adow::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
