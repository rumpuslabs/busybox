...
pub type R = crate::R<AHRS_SPEC>;
#[doc = "Register `AHRS` writer"]
pub type W = crate::W<AHRS_SPEC>;
...
#[cfg(feature = "debug")]
impl core::fmt::Debug for crate::generic::Reg<AHRS_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hours(&mut self) -> HOURS_W<AHRS_SPEC, 0> {
        HOURS_W::new(self)
    }
...
#[doc = "Alarm value for Hours\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ahrs::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ahrs::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
