...
pub type COUNTER_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CCR")
            .field("counter", &format_args!("{}", self.counter().bits()))
            .finish()
    }
}
#[cfg(feature = "debug")]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn counter(&mut self) -> COUNTER_W<CCR_SPEC, 0> {
        COUNTER_W::new(self)
    }
